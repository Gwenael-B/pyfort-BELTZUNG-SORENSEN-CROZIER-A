...
#Première épreuve de hasard : le jeu du bonneteau. Il ne prend pas de paramètre en entrée et retourne True si
# le joueur remporte l'épreuve ou False si le joueur la perd.
def bonneteau():
    ...
    while nmb_tentatives != 2:
        position_cle = random.choice(L)  #Choisit la position de la clé parmi les trois bonneteaux
        ...
        if choix_joueur == position_cle :  #Vérifie si le choix du joueur correspond à la position de la clé
            ...
            L.remove(choix_joueur)  #Retire de la liste de choix possibles le premier choix du joueur
            if nmb_tentatives != 2 :
...
#Deuxième épreuve de hasard : le lancer de dés. Il ne prend pas de paramètre en entrée et retourne True si
# le joueur remporte l'épreuve ou False si le joueur la perd
def jeu_lance_des() :
    ...
    while nmb_essais != 3 :
        ...
        if tuple_joueur[0] == 6 or tuple_joueur[1] == 6 :  #Vérifie si un des dés du joueur est égal à 6
            ...
            tuple_maitre = random.randint(1,6), random.randint(1,6)  #Choisit aléatoirement les dés du maître du jeu
            print("Voici les dés obtenus par le maître du jeu :", tuple_maitre[0], "et", tuple_maitre[1])
