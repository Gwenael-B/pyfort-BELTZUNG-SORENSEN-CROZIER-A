...
# s'il a trouvé la bonne réponse avant que les trois tentatives soient écoulées le programme retourne true.
...
# Les données sont chargées dans la norme utf-8 pour qu'il n'y ait pas de problème d'affichage.
...
#Cette fonction permet de choisir au hasard une énigme, convertit la réponse de l'énigme en minuscules puis affiche la question.
#La réponse du candidat est ensuite convertie en minuscules et comparée à la réponse attendue. Si la réponse est la même,
...
def enigme_pere_fouras():
    ...
    while tentatives_restantes > 0:
        ...
        reponse_candidat = input("Saisissez votre réponse avec le déterminant : ")
        ...
        if reponse_final_candidat == reponse_final_machine:
            print("Bravo, vous gagnez la clé.")
            return True
        else:
